...
class Command(BaseCommand):
    help = "Seed the database with SMEs, Tenants, TenantUsers (safe checks, bunmi123, superadmin, default admins, summary with role breakdown, and CSV/JSON export options)"
