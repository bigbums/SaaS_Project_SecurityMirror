...
from saas_app.core.tests.base import BaseTenantTestCase


class TestTenantInvoiceValidation(BaseTenantTestCase):
    ...
    def test_invoice_field_validations(self):
        ...
        cases = [
            ...
            ("due_date", {
                ...
                "status": "unpaid",
                "description": "Future due date test"
            }, 201, None),
...
class TestTenantInvoiceCurrencies(BaseTenantTestCase):
