...
from saas_app.core.views import (
    ...
    platform_owner_dashboard, platform_tenant_detail, diagnostic_view,
...
# router.register(r"tenant-invoices", TenantInvoiceViewSet, basename="tenantinvoice")
router.register(
    r"tenants/(?P<tenant_id>[^/.]+)/invoices",
    TenantInvoiceViewSet,
    basename="tenantinvoice"
)
...
urlpatterns = [
    ...
    path("api/v1/diagnostic/", diagnostic_view), # 👈 diagnostic endpoint
